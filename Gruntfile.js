module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-cognito-login'
                        // standalone: 'mitchallen.-cognito-login'
                    },
                ...
                files: {
                   ...
                   "./dist/cognito-login.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/cognito-login.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/cognito-login.min.js': ['./dist/cognito-login.js']
                }
            }
        },
